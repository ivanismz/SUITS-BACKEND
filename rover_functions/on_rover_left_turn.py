...
def main():
    ...
    parser.add_argument("--angle", type = int, help="degree of angle for left turn")
    args = parser.parse_args()
    result = args.angle
    client = SshClient(user='pi', remote='10.0.0.1', key_path='~/.ssh/id_rsa.pub')
    # run a list of commands
    client.cmd(['cd LeoRover-SLAM-ROS2/leo_common-ros2', 'source /opt/ros/humble/setup.bash', 'source install/setup.bash', 'python3 ./src/programmed_drive/programmed_drive/left_turn.py'])  
