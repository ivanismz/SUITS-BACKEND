...
def main():
    ...
    parser.add_argument("--distance", type = int, help="distance for forward drive")
    args = parser.parse_args()
    result = args.distance
    client = SshClient(user='pi', remote='10.0.0.1', key_path='~/.ssh/id_rsa.pub')
    # run a list of commands
    client.cmd(['cd LeoRover-SLAM-ROS2/leo_common-ros2', 'source /opt/ros/humble/setup.bash', 'source install/setup.bash', 'python3 ./src/programmed_drive/programmed_drive/forward_drive.py']) 
