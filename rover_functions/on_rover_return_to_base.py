...
def main():
    ...
    client.cmd(['source /opt/ros/humble/setup.bash', 'ros2 topic pub /goal_pose geometry_msgs/PoseStamped \"{header: {frane_id : \'map\'}, pose: {position: {x: 0.0, y: 0.0, z: 0.0}, orientation: {w: 0.0}}}\"']) 
