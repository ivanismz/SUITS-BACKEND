            ...
            (b = m[k]),
              ...
              this.include_option_in_results(b) &&
                ...
                null != b.group_array_index &&
                  ...
                  ((f = this.results_data[b.group_array_index]),
                ...
                (!b.group || this.group_search) &&
                  ...
                  b.search_match
                    ? (g.length &&
                        ((h = b.search_text.search(j)),
                        (i =
                          b.search_text.substr(0, h + g.length) +
                          "</em>" +
                          b.search_text.substr(h + g.length)),
                        (b.search_text =
        ...
        return AbstractChosen.browser_is_supported()
          ? this.each(function () {
              ...
              (c = a(this)),
                ...
                "destroy" === b && d
                  ? d.destroy()
                  : d || c.data("chosen", new Chosen(this, b));
            })
          : this;
      },
    }),
    (Chosen = (function (c) {
      ...
      return (
        ...
        (Chosen.prototype.search_results_mousewheel = function (a) {
          ...
          return (
            a.originalEvent &&
              (b = -a.originalEvent.wheelDelta || a.originalEvent.detail),
            null != b
              ? (a.preventDefault(),
